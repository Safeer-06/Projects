...
<img src="img/men.png"/></center>
<form method="post" action="signin-customer.php" onSubmit="return(Vsignin())">
<br />
...
<?php
include 'getdataCustomer.php';?>
<?php echo $error1; ?><br><br>

<font color="#FFFFFF">Don't have a account?</font> <a href="signup-customer.php">Signup</a>
<br>
